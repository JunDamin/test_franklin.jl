...
# ╔═╡ 023c718e-0695-11ed-3dce-31cf818237e0
begin
	using Distributions
	using CSV
	using DataFrames
...
# ╔═╡ 5385b9d8-bcd8-492b-a46e-77fd2e42ffed
md"""
#### Setting default attributes for plots.
"""

# ╔═╡ c01f9b0e-8066-4c0d-885b-38f3ddb4fa40
begin
	default(label=false)
	Logging.disable_logging(Logging.Warn);
end

# ╔═╡ 9e5a2e10-4f88-4611-a44b-7408b7d87946
md"""
## 4.4 Linear predictions.
"""

# ╔═╡ 8cc23f6b-1e15-4d82-bba1-8174c650c462
begin
	howell1_1 = CSV.read(sr_datadir("Howell1.csv"), DataFrame)
	howell1_2 = howell1_1[howell1_1.age .>= 18, :];
end

# ╔═╡ 1f3f163c-928b-4b02-8f51-4e2339b811e8
md"""
#### Fancy way of ding `scatter(howell1_2.weight, howell1_2.height)`.
"""

# ╔═╡ cb042461-a107-4a80-ab1b-11d45b782f8c
@df howell1_2 scatter(:weight, :height)

# ╔═╡ 51cc7896-6536-428c-875b-c41537609731
md"""
### Code 4.38
"""

# ╔═╡ 85e3d4e8-927a-43df-bf3d-8a294760e36c
let
	N = 100
...
# ╔═╡ db0928da-467b-41a1-8ba0-69c5ec9e5e3d
let
...
# ╔═╡ 62006177-e311-4987-8d65-5aa4ceb34dab
md"""
### Code 4.40
"""

# ╔═╡ a1fa978e-5bb9-41c0-bc60-d05e6e398f24
let
	b = rand(LogNormal(0, 1), 10_000)
	density(b, xlims=(0, 5), bandwidth=0.1)
end

# ╔═╡ 58c20db0-d209-40e5-86e4-82130e23dc84
md"""
### Code 4.41
"""

# ╔═╡ 54ec9959-7719-48fa-97cf-5e9cf6ddbde7
let
	Random.seed!(2971)
	N = 100
...
# ╔═╡ 09212b33-e6a8-428d-8ea9-0a89e21c25d4
md"""
### Code 4.42
"""

# ╔═╡ 50521d7a-8226-4c7e-adf1-8c3d04ecadbc
xbar = mean(howell1_2.weight)

# ╔═╡ 2357c190-8601-42db-a965-fbdd7802b6b6
begin
	...
	m4_3 = sample(height_regr_model(howell1_2.weight, howell1_2.height), NUTS(), 1000)

	m4_3 = resetrange(m4_3);
end

# ╔═╡ 7bc88e4b-cb1d-4c6b-88b0-57bbb1006308
md"""
### Code 4.44
"""

# ╔═╡ 454ee9a7-5c40-40ef-96b1-91cb2b24e163
begin
	m4_3_df = DataFrame(m4_3)
	PRECIS(m4_3_df)
end

# ╔═╡ 45685184-ff0e-464e-b038-3c80ca327a2e
md"""
### Code 4.45
"""

# ╔═╡ 992d8a9e-bdb2-45d3-a64b-1b49afc54998
round.(cov(Matrix(m4_3_df)), digits=3)

# ╔═╡ 195ed2dd-f0ef-4727-baed-947e6f5e7685
md"""
### Code 4.46
"""

# ╔═╡ 77d92702-b609-4892-be81-1961a296c7b9
let
	p = @df howell1_2 scatter(:weight, :height; alpha=0.3, color="#5634f2")
	...
	plot!(x -> a_map + b_map*(x-xbar); linewidth=5, alpha=0.6, color="#f23456")
end

# ╔═╡ 7fee86a2-4294-438d-b2f5-51d5f9bbfc22
md"""
### Code 4.47
"""

# ╔═╡ a8845e62-26b5-45cb-8d52-f6030a69333f
let
...
# ╔═╡ 3ad0d8c7-031a-484a-be37-babbaa1f4af1
md"""
### Code 4.48
"""

# ╔═╡ 441658a9-ea6d-4fcf-a6cf-c238026957a0
begin
	N = 10
	dN = howell1_2[1:N, :]
...
# ╔═╡ 353d0c6b-f841-4883-bbf5-5c9cac73030f
md"""
### Code 4.49
"""

# ╔═╡ 8732ffa1-d6d1-4602-84b1-77bd7091c900
begin
	post = sample(mN, 20)
	post_df = DataFrame(post);
	...
	p = @df dN scatter(:weight, :height; xlims=xlims, ylims=ylims, color="#f23456")
...
# ╔═╡ aac1e9ae-43fa-4585-8d93-83dafd442887
md"""
### Code 4.50
"""

# ╔═╡ 0a25bf7f-3b0e-4cd6-affa-67ebd6e0f0f1
let
	post = sample(m4_3, 1000)
	post_df = DataFrame(post)
...
# ╔═╡ 85958224-640a-4944-9852-d1eba1938d17
density(μ_at_50; lw=2, xlab=L"\mu|weight=50", color="#f23456", fill=true)

# ╔═╡ ca9a0c91-2edd-4613-add0-492af26f7856
md"""
### Code 4.51
"""

# ╔═╡ 1126db75-1e45-49d3-99f3-9b55d2bdf8f7
density(μ_at_50; lw=2, xlab=L"\mu|weight=50")

# ╔═╡ ae2e4c3b-bb2a-4cf9-9c45-864e95777966
md"""
### Code 4.52
"""

# ╔═╡ 3c553001-e741-4d6a-97b4-6c37fd8948b0
PI(μ_at_50, perc_prob=0.89)

# ╔═╡ 9bf74828-d432-4a58-8204-fecf2ab149a4
md"""
### Code 4.53
"""

# ╔═╡ 7c7e1ac6-728b-454e-9ca9-8a2b74d6d7cc
let
...
# ╔═╡ 959e4b38-c157-4c23-924e-68741aef9c65
md"""
### Code 4.54
"""

# ╔═╡ b140db6b-5f0d-4009-b809-ce1416830102
begin
	weight_seq = 25:70
...
# ╔═╡ fb6482f7-2707-46bd-9085-73b8f6e47157
md"""
### Code 4.55
"""

# ╔═╡ b7c58162-848a-42bc-b457-a33597d39851
let
	p = plot()
		for i in 1:size(μ, 1)
			scatter!(weight_seq, μ[i,:]; c="#d23456", alpha=0.2)
		end
	p
end

# ╔═╡ fcdf2d2a-0086-41d2-a597-d5168915347b
md"""
### Code 4.56
"""

# ╔═╡ cac1c5b8-e55c-4a18-b872-a321ef226a47
let
...
# ╔═╡ 62815452-e267-4291-8f81-d36750e65a4d
